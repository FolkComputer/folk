...
// This workqueue implementation uses thread fences, which aren't
// visible to tsan. "tsan_interface.h" has acquire/release functions
// we can use to make tsan understand how the thread fence is
// synchronizing though.
